...
public class P406_QueueReconstructionByHeight{
    ...
    public static void main(String[] args) {
        ...
        int[][] ret = solution.reconstructQueue(people);
        for (int[] ints : ret) {
            System.out.printf('[' + String.valueOf(ints[0]) + ',' + String.valueOf(ints[1]) + ']');
        }
        System.out.println(" ");
        for (int[] p : people) {
            System.out.printf('[' + String.valueOf(p[0]) + ',' + String.valueOf(p[1]) + ']');
        }
    }
